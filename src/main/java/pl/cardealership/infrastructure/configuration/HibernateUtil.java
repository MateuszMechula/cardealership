    ...
    private static SessionFactory loadSessionFactory() {
        try {
            ...
            Metadata metadata = new MetadataSources(standardServiceRegistry)
                    .addAnnotatedClasses(AddressEntity.class)
                    .addAnnotatedClasses(CarServiceRequestEntity.class)
                    .addAnnotatedClasses(CarToBuyEntity.class)
                    .addAnnotatedClasses(CarToServiceEntity.class)
                    .addAnnotatedClasses(CustomerEntity.class)
                    .addAnnotatedClasses(InvoiceEntity.class)
                    .addAnnotatedClasses(MechanicEntity.class)
                    .addAnnotatedClasses(PartEntity.class)
                    .addAnnotatedClasses(SalesmanEntity.class)
                    .addAnnotatedClasses(ServiceEntity.class)
                    .addAnnotatedClasses(ServiceMechanicEntity.class)
                    .addAnnotatedClasses(ServicePartEntity.class)
                    .getMetadataBuilder()
                    .build();
