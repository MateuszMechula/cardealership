...
import pl.cardealership.infrastructure.database.entity._EntityMarker;
import pl.cardealership.infrastructure.database.repository.jpa._JpaRepositoriesMarker;
...
//    );
    ...
    @Bean
    public PersistenceAnnotationBeanPostProcessor exceptionTranslator() {
